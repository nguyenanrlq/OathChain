 ...
 * This file demonstrates how to integrate Oathchain with a web frontend
 */

// For React/Vue/Angular applications
export class OathchainClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new OathchainClient(provider, contractAddress);
